...
var (
	...
	cspStyle   = "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://*.paddle.com https://*.flowxo.com %[2]s"
	cspScript  = "script-src 'self' 'nonce-%[1]s' https://www.google-analytics.com https://*.paddle.com https://*.stream-io-api.com https://*.flowxo.com %[2]s"
	...
	cspConnect = "connect-src 'self' https://www.google-analytics.com https://*.stream-io-api.com wss://*.stream-io-api.com https://*.flowxo.com wss://*.flowxo.com %[2]s"
